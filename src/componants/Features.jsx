...
const BentoCrad = ({ src, title, description }) => {
  return (
      ...
      <div className="container mx-auto px-3 md:px-10">
        <div className="px-5 py-32">
          ...
          <p className="max-w-md font-circular-web text-lg text-blue-50 opacity-50">
            Imerese yourself ina arich and ever-expanding universe where a
            vibrant array of products converge into a interconnected overlay
            experience on your world.
          </p>
        </div>
        <div
          className="border-hsla realtive mb-7 h-96 w-full overflow-hidden rounded-md
       md:h-[65vh]"
        >
          <BentoCrad
        ...
        <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
          ...
          <div className="bento-tilt_1 row-span-1 ms-32 md:col-span-1 sm:ms-0">
            <BentoCrad
          ...
          <div className="bento-tilt_1 me-14 md:col-span-1 md:me-0">
            <BentoCrad
              ...
              description="A cross-world AI Agent - elevating your gameplay to be more 
              fun and productive."
            />
          </div>
          <div className="bento-tilt_2">
            <div className="flex sixe-full flex-col justify-between bg-violet-300 p-5">
